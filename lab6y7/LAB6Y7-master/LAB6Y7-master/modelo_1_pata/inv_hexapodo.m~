...
% Las coordenadas x,y,z expresadas en el sistema de ref del femur son:
        coords_femur = [sqrt(x^2 + y^2) - a_i(1),z,0]';
        ...
        theta2(pata) = acos(((a_i(2))^2 - (a_i(3))^2 + norma)/(2*a2*raiz)) - atan2(coords_femur(2),coords_femur(1)) - theta_2_off;
        theta3(pata) = pi - acos(((a_i(2))^2 + (a_i(3))^2 - norma)/(2*a_i(2)*a_i(3))) - theta_3_off;
